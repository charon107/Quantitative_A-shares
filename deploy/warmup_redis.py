...
print(f"[1/7] load_latest_day: {len(df)} 条, {time.time()-t0:.1f}s")
...
print(f"[2/7] equal_weighted_index(2025-01-01): {len(s)} rows, {time.time()-t0:.1f}s")
